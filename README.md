...
- **Web Design Officer** at *Sydney UAV Engineering* — lead design and maintenance of the SUAVE website, improving accessibility and SEO.  
- **Software Engineering Intern** at *RDA Group* — production work with Next.js, TypeScript and Node.js.

---

## Selected projects
- **Trailblazer** — full stack mapping web app with GeoDjango / PostGIS, PostgreSQL, Redis, CI and AWS ECS deployments.  
- **Novafit** — fitness and nutrition app with Spring Boot backend and React frontend.  
- **Currency Conversion CLI** — Java + SQLite CLI with authentication and transaction history.

(See repos on my profile for links and READMEs)
